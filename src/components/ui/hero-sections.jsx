  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center bg-gray-50 dark:bg-neutral-900">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button className="rounded-md border border-neutral-300 dark:border-neutral-700 px-6 py-2 text-neutral-800 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition">
          Contact Support
        </button>
      </div>
    </section>
